...
export const StatsCard: React.FC<StatsCardProps> = ({
  ...
  if (isDetailedVariant) {
    ...
    return (
      <div className="bg-white p-4 rounded-lg border border-gray-200 flex flex-row justify-between items-start  hover:shadow-md">
  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-gray-200  hover:shadow-md">
