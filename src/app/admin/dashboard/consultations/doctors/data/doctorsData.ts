...
export const convertAPIDoctor = (apiDoctor: DoctorAPI): Doctor => {
  return {
    ...
    specialization_id: apiDoctor.specializations,
    department_id: apiDoctor.departments,
    ...
    languages_known: apiDoctor.languages_known,
    hospitals_id: apiDoctor.hospital.map((h) => h.id),
    is_available_online: apiDoctor.is_available_online,
    is_available_in_person: apiDoctor.is_available_in_person,
    mci: apiDoctor.mci,
    nmc: apiDoctor.nmc,
    ...
    availability: {}, // API doesn't provide this
