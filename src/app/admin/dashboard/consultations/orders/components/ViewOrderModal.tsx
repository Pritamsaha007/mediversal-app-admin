...
const ViewOrderModal: React.FC<ViewOrderModalProps> = ({
  ...
  const getPaymentBadge = (status: string) => {
    const statusStyles = {
      paid: "bg-[#34C759] text-white",
      pending: "bg-[#FF9500] text-white",
      refunded: "bg-[#2F80ED] text-white",
      failed: "bg-[#FF3B30] text-white",
    };
  ...
  const getConsultationTypeBadge = (type: string) => {
    return (
      ...
      >
        {type === "online" ? "Online Consultation" : "Completed"}
      </span>
    );
  };
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2 text-[10px] text-gray-500 mb-4">
              <span>Booking ID: {order.bookingId}</span>
              <span>|</span>
              <span>{order.consultationLanguage}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-2">
                {getConsultationTypeBadge(order.consultationType)}
                {getStatusBadge(order.consultationStatus)}
          ...
          <div className="mb-6">
            <h4 className="text-[10px] font-medium text-[#161D1F] mb-4">
              ...
              {order.paymentStatus === "paid" && (
                <span className="ml-2 inline-flex items-center px-2 py-1 rounded text-[10px] font-medium bg-[#34C759] text-white">
                  Paid
                </span>
              )}
            </h4>
