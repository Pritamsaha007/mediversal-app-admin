  ...
  useEffect(() => {
    if (editingOffering) {
      setFormData({
        ...
        duration_type_id: editingOffering.duration_type_id || "",
      ...
      <div className="bg-white rounded-lg max-w-5xl w-full max-h-[90vh] flex flex-col">
                ...
                <div className="bg-white p-3 rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="h-4 w-4 text-[#0088B1] focus:ring-[#0088B1] border-gray-300 rounded cursor-pointer"
                    />
                    <label
                      htmlFor="is_device"
        ...
        <div className="flex justify-end gap-3 p-6 border-t border-gray-200 flex-shrink-0">
          <button
            ...
            onClick={handleReset}
            disabled={loading}
            className="px-6 py-2 text-[12px] text-gray-600 border border-gray-300 rounded-md hover:bg-gray-50 disabled:opacity-50"
          >
            Reset
          </button>
          <button
            ...
            disabled={loading}
            className="px-6 py-2 text-[12px] bg-[#0088B1] text-white rounded-md hover:bg-[#00729A] disabled:opacity-50"
          >
            {loading
              ? "Saving..."
              : editingOffering
