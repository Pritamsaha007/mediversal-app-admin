      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-3 text-[#899193] border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0088B1] focus:border-transparent outline-none text-[12px]"
          />
        </div>
        <div>
          <label className="block text-[12px] font-medium text-[#161D1F] mb-1">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-3 text-[#899193] text-[12px] border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0088B1] focus:border-transparent outline-none appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          />
        </div>
      </div>
    </div>
